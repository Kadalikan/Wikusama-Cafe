...
exports.addTransaksi = async (request, response) => {
    try {
        /** prepair data to add in transaksi */
        let newTransaksi = {
        ...
        /**assume thath arrdetail is array type */
...
exports.updateTransaksi = async (request, response) => {
    try {
        ...
        /**prepare data uploadded transaksi */
        let dataTransaksi = {
            tgl_transaksi: request.body.tgl_transaksi,
            id_user: request.body.id_user,
            id_meja: request.body.id_meja,
...
exports.getTransaksi = async (request, response) => {
    try {
        ...
        let result = await transaksiModel
            .findAll({ include: ["meja", "user", { model: detailModel, as: "detail_transaksi", include: ["menu"] }] })
